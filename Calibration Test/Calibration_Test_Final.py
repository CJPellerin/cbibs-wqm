...
if Process == 1:
    ...
    print(WQM_data)
    SB_data=(b''.join(SB)).decode('utf-8', 'ignore')
    print(SB_data)
...
if Process ==2: #Old DO values
    ...
    SBE_SOC_Old=str(input('Please Enter the WQM Settings menu. Enter the SBE43IDO.SOC value: '))
...
if Process ==3:
    ...
    print('Please enter the settings menu for the WQM device and change the SBE43IDO.SOC value to what you would like it to be.' )
    SBE_SOC_New=str(input('What is the new SBE43IDO.SOC value? '))
    print('\n Check that the instruments are properly plugged in before starting! \n')
    COM_WQM=(input('What is the COM port for the WQM? (COM#)'))
    COM_Opt=(input('What is the COM port for the Optode? (COM#)'))
...
if Process ==4: 
    ...
    COM_F=input('What is the COM port for the FLNTUS? (COM#)')
    COM_WQM=input('What is the COM port for the WQM? (COM#)')                                                   
    ...
    FLNT_ChlorSF=float(input('What is the FLNTUS scaling factor for the Chlorophyll test?'))
    FLNT_TurbSF=float(input('What is the FLNTUS scaling factor for the Turbidity test?'))
    ...
    FChlA=(F_Chlor_counts-FChlor_dark)*FLNT_ChlorSF   
    FTurbNTU=(F_Turb_counts-FTurb_dark)*FLNT_TurbSF
    ...
    input('Set the WQM into the Chlorophyll tank after stirring. Once you are ready to take data, turn on the device. Press ENTER to define the WQM serial port and change to optics mode.Do this immediately after stirring, it will take 1 min for this process to be completed.\n')
    ...
    WQM_ChlorSF=float(input('What is the WQM scaling factor for the Chlorophyll test? (ECO.SIG1.CAl1)'))
    WQM_TurbSF=float(input('What is the WQM scaling factor for the Turbidity test? (ECO.SIG2.CAL1)'))
    
    Old_WQMChlA=(WQM_Chlor_counts-WQMChlor_dark)*WQM_ChlorSF
    Old_WQMTurbNTU=(WQM_Turb_counts-WQMTurb_dark)*WQM_TurbSF
...
####Don't forget to close the WQM and put it back into standby mode in between stuff!!! After testing, close the bio wiper.
    ...
    if text_choice_4 == 'y':
        ...
        text.write(' NTU')
        text.write('\n')
        text.write('Old FLNTUS Chlorophyll Scaling Factor: ')
        text.write(str(FLNT_ChlorSF))
        text.write('\n')
        text.write('Old FLNTUS Turbidity Scaling Factor: ')
        text.write(str(FLNT_TurbSF))
        text.write('\n')
        text.write('Old WQM Chlorophyll Scaling Factor: (ECO.SIG1.CAL1) ')
        text.write(str(WQM_ChlorSF))
        text.write('\n')
        text.write('Old WQM Turbidity Scaling Factor: (ECO.SIG2.CAL1) ')
        text.write(str(WQM_TurbSF))
        text.write('\n')
        text.close()
...
if Process ==5:
    ...
    New_ChlorSF=float(input('Please enter the settings menu and adjust the Cholorphyll scaling factor. What is the new calibration scaling factor for the Chlorophyll test? (ECO.SIG1.CAL1)'))
    New_TurbSF=float(input('Please enter the settings menu and adjust the Turbidity scaling factor. What is the new calibration scaling factor for the Turbidity test? (ECO.SIG2.CAL1)'))
    ...
    New_WQMChlA=(WQM_Chlor_counts-WQMChlor_dark)*New_ChlorSF
    New_WQMTurbNTU=(WQM_Turb_counts-WQMTurb_dark)*New_TurbSF
...
####Don't forget to close the WQM and put it back into standby mode in between stuff!!! After testing, close the bio wiper.
    ...
    if text_choice_5 == 'y':
        ...
        text.write(' NTU')
        text.write('\n')
        text.write('New Chlorophyll Scaling Factor: (ECO.SIG1.CAL1) ')
        text.write(str(New_ChlorSF))
        text.write('\n')
        text.write('New Turbidity Scaling Factor: (ECO.SIG2.CA1) ')
